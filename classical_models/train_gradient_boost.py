"""Trains a Gradient Boosting Regressor on the unified materials dataset."""
...
class GradientBoostTrainer:
    """Wraps training, prediction and metric computation for Gradient Boosting."""
    ...
    def train(self, train_df: pd.DataFrame) -> float:
        ...
        logger.info("Gradient Boosting trained in %.4fs", elapsed)
        return elapsed
    ...
    def save(self, path: str) -> None:
        ...
        logger.info("Saved Gradient Boosting model to %s", path)
...
if __name__ == "__main__":
    ...
    trainer.save(os.path.join(out_dir, "gb.pkl"))
